...
class Graph:
    def __init__(self, layout, widget, layout_toolbar=None, name_graphics=None, tridimensional=False):
        # Объекты графика
        self.axis = None
        self.figure = None
        self.canvas = None
        ...
        self.initialize(tridimensional=tridimensional)

    def initialize(self, draw=False, tridimensional=False):
